...
// let time1 = 0;  // Player 1's timer in seconds
// let time2 = 0;  // Player 2's timer in seconds
// let currentPlayers = 1;  // Track which player's turn it is (1 or 2) // players
...
//     if (currentPlayer === 1) {
//       time1++;
//       time1Element.textContent = formatTime(time1);
//     }
//   }, 1000);
...
//     if (currentPlayer === 2) {
//       time2++;
//       time2Element.textContent = formatTime(time2);
//     }
//   }, 1000);
// }
...
// // Switch turns after a move is made (you should call this after each move)
// function switchTurn() {
//   currentPlayer = currentPlayer === 1 ? 2 : 1;
// }

// // Example function to handle switching turns (this should be linked to your move logic)
// function handleTurnChange() {
//   switchTurn();
//   clearInterval(timer1Interval);  // Stop the current timer
//   clearInterval(timer2Interval);
//   startGame();  // Start the next player's timer
// }

// // Reset the game (stop timers and reset time)
// function resetGame() {
//   clearInterval(timer1Interval);
//   clearInterval(timer2Interval);
//   time1 = 0;
...
//   // Function to handle switching turns and starting the next player's timer
//   function handleTurnChange() {
//     switchTurn();  // Switch player turn
//     clearInterval(timer1Interval);  // Stop the current player's timer
//     clearInterval(timer2Interval);  // Stop the other player's timer
//     startGame();  // Start the next player's timer
//   }
...
//   // This function is called when a move is completed
//   function onMoveCompleted() {
//     // Handle move logic here (piece movement, check for checkmates, etc.)
    
//     // Switch turns and update the timer
//     handleTurnChange();
//   }
